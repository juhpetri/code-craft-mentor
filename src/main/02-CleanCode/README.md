...
Ensinar o trainee a escrever **código limpo e legível** e aplicar esse conhecimento na **implementação de histórias de usuário reais**, usando o projeto `package com.code.craft.mentor;` como base prática.
